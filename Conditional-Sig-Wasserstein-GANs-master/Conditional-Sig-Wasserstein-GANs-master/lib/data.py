...
def get_equities_dataset(assets=('SPX', 'DJI'), with_vol=True):
   ...
   # start = '2005-01-01 00:00:00+01:00'
    ...
    print('importing')
    df_asset = pd.read_csv('lib\data\SP500_2013_2021_daily.csv')
    price = np.log(df_asset[['Adj Close']].values)
    ...
    data_raw_tensor = torch.tensor(data_raw)
    ...
    pickle_it(data_preprocessed, 'x_real_og.torch')
