...
SIGCWGAN_CONFIGS = dict(
    ...
    VAR1=SigCWGANConfig(
        mc_size=500,
        sig_config_past=SignatureConfig(depth=6, augmentations=tuple([Scale(0.2), Cumsum(), AddLags(m=2), LeadLag()])),
        sig_config_future=SignatureConfig(depth=6,
    ...
    STOCKS_SPX=SigCWGANConfig(
        mc_size=1000,
        sig_config_past=SignatureConfig(depth=3, augmentations=tuple([Scale(0), Cumsum(), AddLags(m=2), LeadLag()])),
